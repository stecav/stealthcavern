...
/** Provide abstract interface for Stealth Cavern engine rendering devices.
 *
 ...
 *
 * As this is for the Stealth Cavern engine, implementations use the the engine's global
 * settings context.
 *
 * @class RenderDevice
 * @author Kurt Rinnert
