...
const std::string VERSION_NAME = "Stealth Cavern";
const int VERSION_MAJOR = 1;
const int VERSION_MINOR = 17;
...
extern int DEATH_PENALTY_SOUL;
extern int DEATH_PENALTY_SOUL_CURRENT;
