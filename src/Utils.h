...
typedef enum {
	...
	EC_REQUIRES_GENERATION = 14,
	EC_REQUIRES_NOT_GENERATION = 15,
	...
	EC_NPC_PORTRAIT_THEM = 48,
	EC_NPC_PORTRAIT_YOU = 49,
	EC_MISSION_TEXT = 50,
	EC_WAS_INSIDE_EVENT_AREA = 51,
	EC_GAMBLE_CURRENCY = 52,
	EC_KILN = 53,
	EC_REWARD_STAT = 54,
	EC_REWARD_TALENT = 55,
	EC_CHANCE_EXEC = 56,
	EC_CHALLENGE_STAT = 57,
	EC_REQUIRES_TALENT = 58
