	...
	, game_slot(0)
{
	...
	label_portrait->set(portrait_label.x, portrait_label.y, portrait_label.justify, portrait_label.valign, msg->get("Choose avatar"), color_normal, portrait_label.font_style);

	label_name = new WidgetLabel();
	label_name->setBasePos(name_label.x, name_label.y);
	label_name->set(name_label.x, name_label.y, name_label.justify, name_label.valign, msg->get("Name"), color_normal, name_label.font_style);

	label_permadeath = new WidgetLabel();
	label_permadeath->setBasePos(permadeath_label.x, permadeath_label.y);
	label_permadeath->set(permadeath_label.x, permadeath_label.y, permadeath_label.justify, permadeath_label.valign, msg->get("Finite life"), color_normal, permadeath_label.font_style);
